            ...
            <div className="col-md-5">
              <div className="about-video">
                ...
                <p className="desc">
                  ...
                  Apart from machines, over the past few decades, we have
                  heavily invested into and nurtured an able, experienced and
                ...
                <div className="video-div-wraper">
                  ...
                  <img src="/images/home3/Background.png" alt="" />
                </div>
              </div>
            </div>
